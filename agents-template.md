...
- **Before working**: use the gitmemo skill `search` interface (`mem.ps1`/`mem.sh search`) to find relevant past solutions; do not search by directly listing files under `.mem`; reuse if applicable.
